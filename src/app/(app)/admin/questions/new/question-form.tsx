...
import { DELIVERY_APPROACHES, DISTRACTOR_FAMILIES, OPTION_BASED_ITEM_TYPES, STYLES } from "@/db/schema";
    ...
    <form action={action} className="space-y-4">
      ...
      <Card className="grid gap-3 sm:grid-cols-2">
        <Field label="ECO task">
          <Select name="syllabus_item_id" value={taskId} onChange={(e) => setTaskId(Number(e.target.value))}>
            {tasks.map((t) => (
